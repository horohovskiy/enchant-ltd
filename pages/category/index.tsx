                        ...
                        >
                            <Dialog.Panel className="relative flex w-full max-w-xs flex-col overflow-y-auto bg-white pb-12 shadow-xl">
                                ...
                                <div className="border-t border-gray-200 px-4 py-6">
                                    <a href="components#" className="-m-2 flex items-center p-2">
                                        <img
                    ...
                    <div className="border-b border-gray-200">
                        <div className="flex h-16 items-center justify-between">
                            <div className="flex flex-1 items-center lg:hidden">
                                ...
                                <a href="components#" className="ml-2 p-2 text-gray-400 hover:text-gray-500">
                            ...
                            <div className="flex flex-1 items-center justify-end">
                                <a href="components#" className="hidden text-gray-700 hover:text-gray-800 lg:flex lg:items-center">
                                    <img
                                        src="https://tailwindui.com/img/flags/flag-canada.svg"
                                        alt=""
                                        className="block h-auto w-5 flex-shrink-0"
                                ...
                                {/* Search */}
                                <a href="components#" className="ml-6 hidden p-2 text-gray-400 hover:text-gray-500 lg:block">
                                    <span className="sr-only">Search</span>
                                    <MagnifyingGlassIcon className="h-6 w-6" aria-hidden="true" />
                                </a>

                                {/* Account */}
                                <a href="components#" className="p-2 text-gray-400 hover:text-gray-500 lg:ml-4">
